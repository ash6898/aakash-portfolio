...
%JAVACMD% %JAVA_OPTS% -Dproject.artifactId=org.apache.sling.feature.launcher -Dproject.version=1.3.2 -Dbuild.timestamp=2024-12-17T14:46:26Z -Dfile.encoding=UTF-8 -classpath %CLASSPATH% -Dapp.name="launcher" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.apache.sling.feature.launcher.impl.Main %CMD_LINE_ARGS%
